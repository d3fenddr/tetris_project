...
LEADERBOARD_PANEL_MAX_WIDTH = 640
...
FALL_SPEED_BASE_SECONDS = 1.0
FALL_SPEED_SCORE_STEP = 500
FALL_SPEED_DECREASE_PER_LEVEL = 0.08
FALL_SPEED_MIN_SECONDS = 0.16
GAME_OVER_REVEAL_DELAY_MS = 850
